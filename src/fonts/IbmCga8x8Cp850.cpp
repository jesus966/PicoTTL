...
//
// Source: 8x8 IBM character font dump (CP850.F08), code page 850 (DOS Multilingual/Latin-1). One byte
...
const std::uint8_t kGlyphData[2048] = {
    // 0x00
...
const Font kIbmCga8x8Cp850{kGlyphData, 8, 8, 1, 256, 7, CodePage::Cp850};
