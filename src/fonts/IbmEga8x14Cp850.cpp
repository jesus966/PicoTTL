...
//
// Source: 8x14 IBM character font dump (CP850.F14), code page 850 (DOS Multilingual/Latin-1). One byte
...
const std::uint8_t kGlyphData[3584] = {
    ...
    // 0x15
    0x00, 0x00, 0x7C, 0xC6, 0x60, 0x38, 0x6C,
    0xC6, 0xC6, 0x6C, 0x38, 0x0C, 0xC6, 0x7C,
    // 0x16
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    // 0x2C ','
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x18, 0x18, 0x18, 0x30, 0x00,
    // 0x2D '-'
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    // 0x60 '`'
    0x00, 0x30, 0x18, 0x0C, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0x61 'a'
    ...
    0xCC, 0xCC, 0xCC, 0x7C, 0x0C, 0xCC, 0x78,
    // 0x68 'h'
    ...
    // 0x70 'p'
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xDC,
    0x66, 0x66, 0x66, 0x7C, 0x60, 0x60, 0xF0,
    // 0x71 'q'
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x76,
    0xCC, 0xCC, 0xCC, 0x7C, 0x0C, 0x0C, 0x1E,
    // 0x72 'r'
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xDC,
    ...
    // 0x79 'y'
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC6,
    0xC6, 0xC6, 0xC6, 0x7E, 0x06, 0x0C, 0x78,
    // 0x7A 'z'
    ...
    0x6C, 0xC6, 0xC6, 0xFE, 0x00, 0x00, 0x00,
    // 0x80
    0x00, 0x00, 0x00, 0x3C, 0x66, 0xC2, 0xC0,
    0xC0, 0xC0, 0xC2, 0x66, 0x3C, 0x0C, 0x78,
    // 0x81
    0x00, 0x00, 0x00, 0xCC, 0x00, 0x00, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0x76, 0x00, 0x00,
    // 0x82
    ...
    0x0C, 0x7C, 0xCC, 0xCC, 0x76, 0x00, 0x00,
    // 0x84
    0x00, 0x00, 0x00, 0xC6, 0x00, 0x00, 0x78,
    0x0C, 0x7C, 0xCC, 0xCC, 0x76, 0x00, 0x00,
    // 0x85
    ...
    // 0x87
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7C,
    0xC6, 0xC0, 0xC0, 0xC6, 0x7C, 0x0C, 0x78,
    // 0x88
    ...
    0xCC, 0xCC, 0xCC, 0xCC, 0x76, 0x00, 0x00,
    // 0x97
    0x00, 0x00, 0x60, 0x30, 0x18, 0x00, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0x76, 0x00, 0x00,
    // 0x98
    ...
    // 0x9B
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7C,
    0xCE, 0xDE, 0xF6, 0xE6, 0x7C, 0x00, 0x00,
    // 0x9C
    0x00, 0x00, 0x38, 0x6C, 0x64, 0x60, 0xF0,
    0x60, 0x60, 0x60, 0xE6, 0xFC, 0x00, 0x00,
    // 0x9D
    0x00, 0x00, 0x04, 0x7C, 0xCE, 0xCE, 0xD6,
    0xD6, 0xD6, 0xE6, 0xE6, 0x7C, 0x40, 0x00,
    // 0x9E
    0x00, 0x00, 0x00, 0x00, 0x00, 0xC6, 0x6C,
    0x38, 0x38, 0x6C, 0xC6, 0x00, 0x00, 0x00,
    // 0x9F
    0x00, 0x00, 0x0E, 0x1B, 0x18, 0x18, 0x18,
    0x7E, 0x18, 0x18, 0x18, 0xD8, 0x70, 0x00,
    // 0xA0
    ...
    0xDE, 0xCE, 0xC6, 0xC6, 0xC6, 0x00, 0x00,
    // 0xA6
    0x00, 0x00, 0x3C, 0x6C, 0x6C, 0x3E, 0x00,
    0x7E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xA7
    0x00, 0x00, 0x38, 0x6C, 0x6C, 0x38, 0x00,
    0x7C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xA8
    0x00, 0x00, 0x00, 0x30, 0x30, 0x00, 0x30,
    0x30, 0x60, 0xC6, 0xC6, 0x7C, 0x00, 0x00,
    // 0xA9
    0x00, 0x00, 0x00, 0x38, 0x44, 0xBA, 0xAA,
    0xB2, 0xAA, 0xAA, 0x44, 0x38, 0x00, 0x00,
    // 0xAA
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0xFE, 0x06, 0x06, 0x06, 0x00, 0x00, 0x00,
    // 0xAB
    0x00, 0x00, 0x60, 0xE0, 0x63, 0x66, 0x6C,
    0x18, 0x30, 0x6E, 0xC3, 0x06, 0x0C, 0x1F,
    // 0xAC
    0x00, 0x00, 0x60, 0xE0, 0x63, 0x66, 0x6C,
    0x1A, 0x36, 0x6E, 0xDA, 0x3F, 0x06, 0x06,
    // 0xAD
    0x00, 0x00, 0x00, 0x18, 0x18, 0x00, 0x18,
    0x18, 0x3C, 0x3C, 0x3C, 0x18, 0x00, 0x00,
    // 0xAE
    0x00, 0x00, 0x00, 0x00, 0x00, 0x36, 0x6C,
    0xD8, 0x6C, 0x36, 0x00, 0x00, 0x00, 0x00,
    // 0xAF
    0x00, 0x00, 0x00, 0x00, 0x00, 0xD8, 0x6C,
    0x36, 0x6C, 0xD8, 0x00, 0x00, 0x00, 0x00,
    // 0xB0
    ...
    // 0xB5
    0x30, 0x60, 0xC0, 0x10, 0x38, 0x6C, 0xC6,
    0xC6, 0xFE, 0xC6, 0xC6, 0xC6, 0x00, 0x00,
    // 0xB6
    0x38, 0x6C, 0xC6, 0x10, 0x38, 0x6C, 0xC6,
    0xC6, 0xFE, 0xC6, 0xC6, 0xC6, 0x00, 0x00,
    // 0xB7
    0x18, 0x0C, 0x06, 0x10, 0x38, 0x6C, 0xC6,
    0xC6, 0xFE, 0xC6, 0xC6, 0xC6, 0x00, 0x00,
    // 0xB8
    0x00, 0x00, 0x00, 0x38, 0x44, 0x9A, 0xA2,
    0xA2, 0xA2, 0x9A, 0x44, 0x38, 0x00, 0x00,
    // 0xB9
    ...
    0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xBD
    0x00, 0x00, 0x18, 0x18, 0x7C, 0xC6, 0xC0,
    ...
    0xFF, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
    // 0xC6
    0x00, 0x00, 0x00, 0x76, 0xDC, 0x00, 0x78,
    0x0C, 0x7C, 0xCC, 0xCC, 0x76, 0x00, 0x00,
    // 0xC7
    0x76, 0xDC, 0x00, 0x10, 0x38, 0x6C, 0xC6,
    0xC6, 0xFE, 0xC6, 0xC6, 0xC6, 0x00, 0x00,
    // 0xC8
    ...
    0xF7, 0x36, 0x36, 0x36, 0x36, 0x36, 0x36,
    // 0xCF
    0x00, 0x00, 0x00, 0x00, 0x00, 0xC6, 0x7C,
    0xC6, 0xC6, 0xC6, 0x7C, 0xC6, 0x00, 0x00,
    // 0xD0
    0x00, 0x00, 0x00, 0x34, 0x18, 0x2C, 0x06,
    0x3E, 0x66, 0x66, 0x66, 0x3C, 0x00, 0x00,
    // 0xD1
    0x00, 0x00, 0x00, 0xF8, 0x6C, 0x66, 0x66,
    0xF6, 0x66, 0x66, 0x6C, 0xF8, 0x00, 0x00,
    // 0xD2
    0x38, 0x6C, 0x00, 0xFE, 0x66, 0x62, 0x68,
    0x78, 0x68, 0x62, 0x66, 0xFE, 0x00, 0x00,
    // 0xD3
    0x00, 0xC6, 0x00, 0xFE, 0x66, 0x62, 0x68,
    0x78, 0x68, 0x62, 0x66, 0xFE, 0x00, 0x00,
    // 0xD4
    0x30, 0x18, 0x00, 0xFE, 0x66, 0x62, 0x68,
    0x78, 0x68, 0x62, 0x66, 0xFE, 0x00, 0x00,
    // 0xD5
    0x00, 0x00, 0x00, 0x1E, 0x33, 0x60, 0xFE,
    0x60, 0xFC, 0x60, 0x33, 0x1E, 0x00, 0x00,
    // 0xD6
    0x0C, 0x18, 0x00, 0x3C, 0x18, 0x18, 0x18,
    0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00,
    // 0xD7
    0x3C, 0x66, 0x00, 0x3C, 0x18, 0x18, 0x18,
    0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00,
    // 0xD8
    0x00, 0x66, 0x00, 0x3C, 0x18, 0x18, 0x18,
    0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00,
    // 0xD9
    0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
    ...
    0x00, 0x00, 0x18, 0x18, 0x18, 0x18, 0x00,
    // 0xDE
    0x30, 0x18, 0x00, 0x3C, 0x18, 0x18, 0x18,
    0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00,
    // 0xDF
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xE0
    0x18, 0x30, 0x00, 0x7C, 0xC6, 0xC6, 0xC6,
    0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00,
    // 0xE1
    0x00, 0x00, 0x00, 0x78, 0xCC, 0xCC, 0xCC,
    0xD8, 0xCC, 0xC6, 0xC6, 0xCC, 0x00, 0x00,
    // 0xE2
    0x38, 0x6C, 0x00, 0x7C, 0xC6, 0xC6, 0xC6,
    0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00,
    // 0xE3
    0x30, 0x18, 0x00, 0x7C, 0xC6, 0xC6, 0xC6,
    0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00,
    // 0xE4
    0x00, 0x00, 0x00, 0x76, 0xDC, 0x00, 0x7C,
    0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00,
    // 0xE5
    0x76, 0xDC, 0x00, 0x7C, 0xC6, 0xC6, 0xC6,
    0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00,
    // 0xE6
    ...
    // 0xE8
    0x00, 0x00, 0x00, 0xF0, 0x60, 0x7C, 0x66,
    0x66, 0x66, 0x7C, 0x60, 0xF0, 0x00, 0x00,
    // 0xE9
    0x18, 0x30, 0x00, 0xC6, 0xC6, 0xC6, 0xC6,
    0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00,
    // 0xEA
    0x38, 0x6C, 0x00, 0xC6, 0xC6, 0xC6, 0xC6,
    0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00,
    // 0xEB
    0x30, 0x18, 0x00, 0xC6, 0xC6, 0xC6, 0xC6,
    0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00,
    // 0xEC
    0x00, 0x00, 0x0C, 0x18, 0x30, 0x00, 0xC6,
    0xC6, 0xC6, 0xC6, 0x7E, 0x06, 0x0C, 0xF8,
    // 0xED
    0x0C, 0x18, 0x00, 0x66, 0x66, 0x66, 0x66,
    0x3C, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00,
    // 0xEE
    0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xEF
    0x00, 0x0C, 0x18, 0x30, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xF0
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x18, 0x18, 0x00, 0x00, 0x7E, 0x00, 0x00,
    // 0xF2
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0xFF, 0x00, 0xFF,
    // 0xF3
    0x00, 0xE0, 0x30, 0x63, 0x36, 0xEC, 0x18,
    ...
    // 0xF7
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x18, 0x0C, 0x78,
    // 0xF8
    0x00, 0x38, 0x6C, 0x6C, 0x38, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xF9
    0x00, 0xC6, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xFA
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xFB
    0x00, 0x18, 0x38, 0x18, 0x18, 0x18, 0x3C,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xFC
    0x00, 0x78, 0x0C, 0x38, 0x0C, 0x0C, 0x78,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xFD
    0x00, 0x3C, 0x66, 0x0C, 0x18, 0x32, 0x7E,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    // 0xFE
...
const Font kIbmEga8x14Cp850{kGlyphData, 8, 14, 1, 256, 12, CodePage::Cp850};
