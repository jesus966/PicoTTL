// PicoTTL - Example 03: single horizontal line
//
// Validates Graphics::drawHorizontalLine(): a single white line across
// the middle of the screen, on a black background.
//
...
int main() {
    ...
    gfx.clear();
    gfx.drawHorizontalLine(0, display.height() / 2, display.width(),
